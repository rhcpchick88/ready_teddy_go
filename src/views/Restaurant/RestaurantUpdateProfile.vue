<template>
    ...
    <v-app id="inspire">
        ...
        <v-btn @click="updateRestaurant(name, address, bio, city, email, password, phoneNum)"> Update </v-btn>
        </v-container>
        </v-form>
    </v-app>
</div>
...
import {mapActions} from 'pinia'
    ...
    export default {
        ...
        methods: {
            ...mapActions(useRestaurantStore,['updateRestaurant']),
